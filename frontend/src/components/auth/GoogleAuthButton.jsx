...
const GOOGLE_CLIENT_ID = '658426092732-l6odo2d5esndtljmu4brsvu31f3lp9kk.apps.googleusercontent.com';

export const GoogleAuthButton = ({ text = 'Continue with Google' }) => {
