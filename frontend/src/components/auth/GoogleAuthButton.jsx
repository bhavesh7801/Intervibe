...
const GOOGLE_CLIENT_ID = import.meta.env.VITE_GOOGLE_CLIENT_ID || '658426092732-l6odo2d5esndtljmu4brsvu31f3lp9kk.apps.googleusercontent.com';
...
export const GoogleAuthButton = ({ text = 'Continue with Google' }) => {
  ...
  const handleGoogleClick = () => {
    ...
    // Force immediate redirect to Google's official sign-in page
