  ...
  return (
    <section className="w-full max-w-[1600px] mx-auto px-4 sm:px-6 lg:px-12 py-16 lg:py-24 border-t border-[#162035]/60 relative z-10">
      <motion.div 
        ...
        viewport={{ once: true }}
        className="rounded-3xl bg-[#080d1a] border border-blue-500/20 p-8 sm:p-12 lg:p-14 shadow-2xl relative overflow-hidden"
      >
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 lg:gap-20 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            <p className="text-sm sm:text-base text-slate-300 leading-loose">
            ...
            <button
              ...
              className="px-8 py-4 rounded-xl bg-blue-600 hover:bg-blue-500 text-white font-extrabold text-xs sm:text-sm shadow-xl shadow-blue-500/30 flex items-center gap-2 transition-all cursor-pointer group hover:scale-[1.03] active:scale-95"
            >
          ...
          <div className="lg:col-span-7">
            <div className="p-7 rounded-2xl bg-[#05070e] border border-[#162035] space-y-5 font-mono text-xs">
              <div className="flex items-center justify-between pb-4 border-b border-[#162035] text-slate-400">
                <span className="text-blue-300 font-bold text-sm">Topology: Global Financial Gateway</span>
