...
import { ArrowRight, Play, Star, Sparkles, Mic, Code2, ShieldCheck, Zap } from 'lucide-react';
  ...
  return (
    <section className="relative w-full flex flex-col items-center pt-8 sm:pt-12 lg:pt-16 pb-12 overflow-hidden">
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none z-0">
        <div className="absolute top-[-10%] left-1/2 -translate-x-1/2 w-[1000px] h-[550px] bg-gradient-to-b from-blue-600/25 via-indigo-600/15 to-transparent rounded-full blur-[140px] mix-blend-screen" />
        <div className="absolute top-[25%] -left-[10%] w-[500px] h-[400px] bg-cyan-500/15 rounded-full blur-[130px] mix-blend-screen" />
        <div className="absolute top-[35%] -right-[10%] w-[500px] h-[400px] bg-purple-600/15 rounded-full blur-[130px] mix-blend-screen" />
      </div>
      ...
      <div className="relative w-full max-w-[1360px] mx-auto px-4 sm:px-6 lg:px-8 text-center flex flex-col items-center z-10">
        ...
        <motion.h1 
          ...
          className="text-4xl sm:text-6xl lg:text-7xl font-black text-white tracking-tight leading-[1.08] max-w-4xl mx-auto font-heading"
        >
        ...
        <motion.p 
          ...
          className="mt-6 sm:mt-7 text-base sm:text-lg lg:text-xl text-slate-300 max-w-2xl mx-auto font-normal leading-relaxed"
        >
        ...
        {/* CTA Buttons - Matching width on PC for perfect symmetry */}
        <motion.div 
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
        ...
        >
          <button
            ...
            className="w-full sm:w-[270px] lg:w-[290px] h-13 sm:h-14 px-6 sm:px-8 rounded-2xl text-base font-bold text-white bg-gradient-to-r from-blue-600 via-indigo-600 to-cyan-500 hover:brightness-110 shadow-[0_0_35px_rgba(37,99,235,0.45)] border border-blue-400/40 flex items-center justify-center gap-3 transition-all cursor-pointer group hover:scale-[1.02] active:scale-95 text-center shrink-0"
          >
          ...
          <button
            ...
            className="w-full sm:w-[270px] lg:w-[290px] h-13 sm:h-14 px-6 sm:px-8 rounded-2xl text-base font-semibold text-slate-200 bg-[#0B1124]/90 hover:bg-[#121b38] border border-slate-700/80 hover:border-slate-500 flex items-center justify-center gap-3 transition-all cursor-pointer hover:scale-[1.02] active:scale-95 text-center backdrop-blur-md shadow-lg shrink-0"
          >
        ...
        {/* Centerpiece Showcase Console (Wide, Centered & High-Impact on PC) */}
        <motion.div
          initial={{ opacity: 0, y: 30 }}
          animate={{ opacity: 1, y: 0 }}
          transition={{ duration: 0.8, delay: 0.4 }}
          className="mt-12 sm:mt-16 w-full max-w-4xl lg:max-w-5xl text-left"
        >
